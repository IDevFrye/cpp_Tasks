...
int main()
{
    ...
    if ((x1 == x2) || (y1 == y2)) { // исключаем случаи с одинаковом столбцом или строчкой
        std::cout << "Ложь. Слон не способен переместиться заданным образом, завершение программы." << std::endl;
        return 0;
    }
    if (abs(x1 - x2) == abs(y1 - y2)) {
        std::cout << "Истина. Слон способен переместиться заданным образом и побить фигуру, стоящую там, завершение программы." << std::endl;
        return 0;
    }
    else {
        std::cout << "Ложь. Слон не способен переместиться заданным образом, завершение программы." << std::endl;
